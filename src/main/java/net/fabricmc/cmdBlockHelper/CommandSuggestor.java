...
import net.fabricmc.cmdBlockHelper.mixin.ChatInputSuggestorAccessor;
...
// Some testing function. Not really useful right now
// Might expand in the future into the actual intellisense handler for the IDE
public class CommandSuggestor extends ChatInputSuggestor {
    ...
    public void renderMessages(MatrixStack matrices) {
        ...
        ChatInputSuggestorAccessor mixin = ((ChatInputSuggestorAccessor)this);
